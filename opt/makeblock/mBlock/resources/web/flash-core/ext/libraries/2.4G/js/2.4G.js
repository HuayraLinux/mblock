...
(function(ext) {
	...
	var axismap = {"RX":0,"RY":1,"LX":2,"LY":3}
	var values = {};
	var indexs = [];
	...
	ext.getJoystickValue6 = function(nextID,axis){
		
	}
	ext.checkKey = function(nextID,key){
    ...
    function tryNextDevice() {
        ...
        if (_device) {
            _device.open({ stopBits: 0, bitRate: 115200, ctsFlowControl: 0 }, _deviceOpened);
        }
    }
    ...
    var descriptor = {};
	ScratchExtensions.makeblockRegister('Joystick(Arduino Mode Only)', descriptor, ext, {type: 'serial'});
})({});
